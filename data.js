...
const LEADERBOARD = {
  ...
  // for this round) — update with the real published table once available.
  ...
  teams: [
    ...
    { pos:  4, name: "POTTEKESTAMP",     gsp: 1, gew: 1, gel: 0, verl: 0, goalsFor:  9, goalsAgainst:  4, saldo:   5, ptn: 3 },
